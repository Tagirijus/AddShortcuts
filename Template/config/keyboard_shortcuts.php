...
<div class="panel">
    ...
    <ul>
        ...
        <li><?= t('Open AddShortCuts drop down') ?> = <strong>F</strong></li>
        ...
        <li><?= t('Saves the actual url as a shortcut preset') ?> = <strong>A</strong></li>
        <?= $this->addShortcutsHelper->getHelpList() ?>
    </ul>
    <h3><?= t('Board view') ?></h3>
    <ul>
    ...
    <ul>
        ...
        <li><?= t('Change complexity') ?> = <strong>x</strong><br><i>(need <a href="https://github.com/Tagirijus/AddSpentTime" target="_blank">AddSpentTime</a> for this to work)</i></li>
